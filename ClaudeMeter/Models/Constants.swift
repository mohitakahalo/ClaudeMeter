...
enum Constants {
    ...
    enum Pacing {
        ...
        static let heavyOveruseThreshold: Double = 2.5
        ...
        /// Minimum utilization before a limit-hit is projected. Below this, an early
        /// front-loaded burst is treated as noise; at or above it a lockout warning
        /// surfaces immediately, without waiting out `minimumElapsedFraction`.
        static let minimumUsageForProjection: Double = 5.0
